...
public class setTMShadow : MonoBehaviour
{
    public static setTMShadow Instance;
 
    public CompositeCollider2D tilemapCollider;
    public GameObject shadowCasterContainer;
    public List<GameObject> shadowCasters = new List<GameObject>(), toDelete = new List<GameObject>();
    public List<PolygonCollider2D> shadowPolygons = new List<PolygonCollider2D>();
    public List<UnityEngine.Rendering.Universal.ShadowCaster2D> shadowCasterComponents = new List<UnityEngine.Rendering.Universal.ShadowCaster2D>();
